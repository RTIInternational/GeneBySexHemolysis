...
# v6 changes:
#   - Added --chi2_df argument
#   - Changed lambda calculation so that it will work for 2df test
#   - Added --qq_lambda argument so that calculation of lambda is optional
#   - Created functions for generating QQ and Manhattan plots
#   - Moved lambda printout to top of plot
#   - Added --manhattan_cex_axix option for altering size of axis annotation
#   - Added --manhattan_cex_label option for altering size of x and y labels
